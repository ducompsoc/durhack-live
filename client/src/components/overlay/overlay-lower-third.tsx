...
import { type IOverlayState, pushHackathon, useHackathon } from "@/lib/socket"
import { waitFor } from "@/lib/utils"

import { DynamicFaIcon } from "@/components/dynamic-fa-icon"
import { NextUpCountdown, YoutubeContext } from "./"

export function OverlayLowerThird() {
  ...
  return (
    <div className="lower-third" ref={containerRef}>
      ...
      <div className="main-text">
        <div className="bg" />
        <div className="icon">
          <DynamicFaIcon iconClassName={icon ?? ""} />
        </div>
        <div className="text">
